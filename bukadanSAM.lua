...
function init_gear_sets()
	...
	sets.precast.WS['Tachi: Fudo'] = {
		...
		body="Phorcys Korazin",hands="Mikinaak Gauntlets",ring1="Pyrosoul Ring",ring2="Rajas Ring",
		back="Buquwik Cape",waist="Light Belt",legs="Xaddi Cuisses",feet="Gorney Sollerets +1"}
	sets.precast.WS['Tachi: Fudo'].Acc = {
		head="Yaoyotl Helm",neck="Ganesha's Mala",ear1="Bladeborn Earring",ear2="Steelflash Earring",
		body="Phorcys Korazin",hands="Mikinaak Gauntlets",ring1="Pyrosoul Ring",ring2="Rajas Ring",
		back="Buquwik Cape",waist="Light Belt",legs="Mikinaak Cuisses",feet="Whirlpool Greaves"}
	...
	sets.engaged.Acc = {head="Yaoyotl Helm",neck="Ganesha's Mala",ear1="Bladeborn Earring",ear2="Steelflash Earring",
		body="Xaddi Mail",hands="Xaddi Gauntlets",ring1="K'ayres Ring",ring2="Rajas Ring",
		back="Takaha Mantle",waist="Dynamic Belt +1",legs="Xaddi Cuisses",feet="Mikinaak Greaves"}
	sets.engaged.PDT = {head="Lithelimb Cap",neck="Ziel Charm",ear1="Bladeborn Earring",ear2="Steelflash Earring",
	...
	sets.engaged.Adoulin = {
		...
		body="Xaddi Mail",hands="Xaddi Gauntlets",ring1="K'ayres Ring",ring2="Rajas Ring",
		back="Takaha Mantle",waist="Windbuffet Belt",legs="Otronif Brais +1",feet="Otronif Boots +1"}
	sets.engaged.Adoulin.Acc = {head="Yaoyotl Helm",neck="Ganesha's Mala",ear1="Bladeborn Earring",ear2="Steelflash Earring",
		body="Xaddi Mail",hands="Xaddi Gauntlets",ring1="K'ayres Ring",ring2="Rajas Ring",
		back="Takaha Mantle",waist="Dynamic Belt +1",legs="Xaddi Cuisses",feet="Mikinaak Greaves"}
